            ...
            <div className="_wrapper flex overflow-hidden flex-col md:flex-row gap-y-[16px] gap-x-[16px]">
                ...
                <div className="w-full md:w-3/4 xl:w-2/3 flex flex-col gap-y-[16px] md:gap-y-[24px]">
                    ...
                    <div className="grid grid-cols-2 gap-y-[12px]">
                        <div data-aos="fade-right" data-aos-duration="800" className="col-span-2 flex flex-col py-[12px] gap-y-[12px] border-b-[1px] border-[#92B7E0]">
                        ...
                        <div data-aos="fade-right" data-aos-duration="800" className="col-span-1 flex flex-col py-[12px] gap-y-[12px]  border-b-[1px] border-[#92B7E0]">
